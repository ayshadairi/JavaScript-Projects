...
if (activePlayer =z= 'O') {
    ...
    disableClick();
    //This function waits second before the computer places an image and enables click.
...
function checkWinConditions() {
    ...
    // X 0, 4, 8 condition.
    else if (arrayIncludes('0X', '4X', '8X')) { drawWinLine(100, 100, 520, 520, 520) }
    //00, 1, 2 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x2 = coordX2,
        //This line indicates where the end of a lines axis is.
        y2 = coordY2,
